window.addEventListener('load', function() {
	...
	var odstraniBarvoButton = document.querySelector('#odstraniBarve');
	odstraniBarvoButton.addEventListener('click', function() {
	...
	//Stroboskop
	var vrednosti = [];
	var minCas = document.querySelector('#min');;
	var maxCas = document.querySelector('#max');;
	var ustavi = false;
